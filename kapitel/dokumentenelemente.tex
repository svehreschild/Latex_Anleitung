...
\subsection{Tabellen}
In \LaTeX{} können Tabellen auf einige Weisen erstellt werden. Die wichtigsten Möglichkeiten und Optionen werden im Folgenden vorgestellt.

\subsubsection{Einfache Tabelle}
Eine einfache Tabelle kann mit der \textbf{\texttt{tabular}}-Umgebung erstellt werden. Die Spalten werden durch \textbf{\texttt{\&}} und die Zeilen durch \textbf{\texttt{\textbackslash\textbackslash}} getrennt. Häufig wird die \textbf{\texttt{tabular}}-Umgebung in einer \textbf{\texttt{table}}-Umgebung verwendet, um die Tabelle zu positionieren, zu beschriften und zu referenzieren (siehe auch: \nameref{sec:querverweise}).
...
Darüber hinaus können die Spalten mit \textbf{\texttt{l}}, \textbf{\texttt{r}} und \textbf{\texttt{c}} für linksbündig, rechtsbündig und zentriert ausgerichtet werden. Mit \textbf{\texttt{\textbackslash hline}} können vertikale Linien eingefügt werden. In dem folgenden Beispiel werden zudem die Möglichkeiten doppelter horizontaler Linien (\textbf{\texttt{\textbackslash hline \textbackslash hline}}) und doppelter vertikaler Linien (\textbf{\texttt{||}}) visualisiert.
...
\textbf{Hier gehts gleich weiter.....}
...
\begin{table}[h]
    ...
    \begin{tabular}{p{5cm} p{7cm}}
        ...
        Farbige Spalte                   & \{\textbackslash columncolor\{gray!20\}\}c                                                              \\
        Linksbündige Spalte mit Umbruch  & \{\textbackslash raggedright\textbackslash arraybackslash\}p\{4cm\}                                     \\
        Zentrierte Spalte mit Umbruch    & \{\textbackslash centering\textbackslash arraybackslash\}p\{4cm\}                                       \\
        Rechtsbündige Spalte mit Umbruch & \{\textbackslash raggedleft\textbackslash arraybackslash\}p\{4cm\}                                      \\
        Mathematische Spalte             & \{$\}c<\{$\}                                                                                            \\
        Mehrzeilige Spalte (Mitte)       & m\{3cm\}                                                                                                \\
        Mehrzeilige Spalte (Unten)       & b\{3cm\}                                                                                                \\
        Mehrzeilige Spalte (Oben)        & p\{3cm\}                                                                                                \\
        Eigene Spaltentypen definieren   & \textbackslash newcolumntype\{X\}\{>\{\textbackslash centering\textbackslash arraybackslash\}p\{3cm\}\} \\
        Alternierende Zeilenfarben       & \textbackslash rowcolors\{2\}\{gray!20\}\{white\}                                                       \\
        Größere Zeilenhöhe setzen        & \textbackslash renewcommand\{\textbackslash arraystretch\}\{1.3\}                                       \\
        Spaltenabstand erhöhen           & \textbackslash setlength\{\textbackslash tabcolsep\}\{8pt\}                                             \\
        Mehrere Spalten verbinden        & \textbackslash multicolumn\{2\}\{c\}\{Text\}                                                            \\
        Mehrere Zeilen verbinden         & \textbackslash multirow\{2\}\{*\}\{Text\}                                                               \\
        \bottomrule
    \end{tabular}

    \caption{Übersicht aller `array`-Formatierungsoptionen}
