...
In den \textbf{\texttt{align}}-Umgebungen können die Gleichungen separat mit \textbf{\texttt{\textbackslash label\{...\}}} versehen werden, um sie im Text referenzieren zu können (\autoref{eq:trig} und \autoref{eq:euler}). Soll die Nummerierung einer einzelnen Gleichung unterdrückt werden, kann dies mit \textbf{\texttt{\textbackslash nonumber}} erreicht werden. Durch das Verwenden von \textbf{\texttt{\textbackslash begin\{align*\}}} werden alle Gleichungen in der Umgebung nicht nummeriert.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{anlagen/bilder/Graph.png}
...
\subsection{Tabellen}
\textcolor{red}{\LARGE hier geht es weiter}
