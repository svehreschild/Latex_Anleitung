...
\usepackage{siunitx}            % Einheiten -> \SI{wert}{\einheit}
    ...
    \sisetup{group-separator = {.}} % Punkt als Tausendertrennzeichen
...
\lstset{
    ...
    basicstyle=\normalsize\ttfamily,    % Monospace-Schriftart
...
% Abkürzungsliste
\usepackage{acronym}            % Ermöglicht die Erstellung einer Abkürzungsliste
